			...
			public void mouseClicked(MouseEvent e) {
				...
				try {
					...
					for(RecordInfoVO imsi : recordArr) {
						...
						// 3. 가수명 불일치 
						else if(!orderWho.equals(imsi.getCdOrder()) ){
...
//	               // 구매수량 : sooBuy (buySet)
//	               
//	               System.out.println("구매할때 음원 : " + cd + " 구매하는 수량 : " + sooBuy );
//	               
//	               // 0보다 작은 수를 입력했을 때
//	               if (sooBuy < 1) {//sooBuy < 1      //1보다 큰 수를 입력해 주세요.
//	                  JOptionPane.showMessageDialog(null,"1보다 큰 수를 입력해 주세요.", "Error", JOptionPane.ERROR_MESSAGE);   
...
//	               // 구매가 가능할 때
//	               else {
//	                  boolean up = reDao.update_soo(sooBuy, cd); // 음원 명과 구매 수량을 파라미터로 넘겨준다!
////	                  
////	                  if(sooSet.getText().equals("재고 없음")) {
////	                     JOptionPane.showMessageDialog(null,"재고가 없습니다.", "Error", JOptionPane.ERROR_MESSAGE);
////	                  }else if (up){
...
//	            } catch (Exception e2) {
//	               // TODO: handle exception
//	               JOptionPane.showMessageDialog(null,"정수를 입력해 주세요.", "Error", JOptionPane.ERROR_MESSAGE);   
//	            }
//	         }
//	            
//	      });///////////////////////////////////////////////////////////////////////////////////////////////////
