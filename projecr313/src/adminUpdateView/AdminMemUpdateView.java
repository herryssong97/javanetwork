...
public class AdminMemUpdateView extends JFrame {
	...
	public void AdminMemUpdateGui() {
		...
		searchBtn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				resultArea.setText("");
				gname = searchField.getText();

				if (gname.isEmpty()) {
					JOptionPane.showMessageDialog(null, "검색 내용을 입력해주세요.", "ERROR_MESSAGE", JOptionPane.ERROR_MESSAGE);
				} else {
					try {
						ArrayList<AdminMemUpdateVO> nArray = amdao.searchByName(gname);
